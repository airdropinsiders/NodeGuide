...
echo "Showing logo..."
wget -O loader.sh https://raw.githubusercontent.com/vinskasenda/NodeGuide/refs/heads/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://raw.githubusercontent.com/vinskasenda/NodeGuide/refs/heads/main/logo.sh | bash
sleep 2
...
echo "Subscribe: https://t.me/AirdropInsiderID"